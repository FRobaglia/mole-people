      ...
      <div class="zoom__section__inner">
        ...
        <div class="zoom">
          ...
          <div class="zoom__final">
            <p>
              La ville cache sous ses trottoirs un labyrinthe de couloirs sombres et humides. Anciens métros désaffectés, bouches d’égouts, tunnels ; plusieurs niveaux s’enfonçant à plus de 30 mètres de profondeur accueillent une population “d’invisibles” venus se réfugier dans l’obscurité, loin des regards indiscrets. 
            </p>
          </div>
        </div>
